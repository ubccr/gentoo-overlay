...
inherit linux-info toolchain-funcs tmpfiles

DESCRIPTION="Application containers for Linux"
="https://github.com/sylabs/singularity"
SRC_URI="https://github.com/sylabs/${PN}/releases/download/v${PV}/${PN}-ce-${PV}.tar.gz"
...
src_install() {
	...
	dotmpfiles "${FILESDIR}/tmpfiles.d/singularity.conf"
