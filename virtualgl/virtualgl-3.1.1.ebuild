...
inherit cmake-multilib flag-o-matic systemd verify-sig
...
#	SRC_URI="mirror://sourceforge/project/${PN}/${PV}/${MY_P}.tar.gz"
    KEYWORDS="amd64 ~x86"
	SRC_URI="
		https://github.com/VirtualGL/virtualgl/releases/download/${PV}/VirtualGL-${PV}.tar.gz
		verify-sig? ( https://github.com/VirtualGL/virtualgl/releases/download/${PV}/VirtualGL-${PV}.tar.gz.sig )
	"
fi
